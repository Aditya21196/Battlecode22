...
public class PathFindingConstants {
    ...
    public static final double RUBBLE_SCORE_MULTIPLIER =12.3;
    public static final double RUBBLE_SCORE_LOCAL_MULTIPLIER =0.4;

    public static final int MIN_AFFORD_PATH_OPT =2820;
    ...
    public static final int CACHING_RUBBLE_LIMIT=21;
    // 8 means 180 degrees
