...
public class PathFindingConstants {
    ...
    public static final double RUBBLE_SCORE_MULTIPLIER =5.66;
    public static final double RUBBLE_SCORE_LOCAL_MULTIPLIER =6.63;

    public static final int MIN_AFFORD_PATH_OPT =3500;
    public static final int NUM_BETTER_LOC_ITERATIONS =4;
    public static final int SOLDIER_PATHFINDING_LIMIT =3221;
    public static final int MINER_PATHFINDING_LIMIT =3251;
