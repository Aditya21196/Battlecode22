...
public class PathFindingConstants {
    ...
    public static final double RUBBLE_SCORE_MULTIPLIER =3.0;
    public static final double RUBBLE_SCORE_LOCAL_MULTIPLIER =10.5;

    public static final int MIN_AFFORD_PATH_OPT =3000;
    public static final int NUM_BETTER_LOC_ITERATIONS =1;
    public static final int SOLDIER_PATHFINDING_LIMIT =2500;
    public static final int MINER_PATHFINDING_LIMIT =4000;
    public static final int DEFAULT_LIMIT =3280;
    public static final int CACHING_RUBBLE_LIMIT=20;
    // 8 means 180 degrees
    public static final int VISION_RADIUS=13;
