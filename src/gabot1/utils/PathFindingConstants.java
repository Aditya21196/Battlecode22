...
public class PathFindingConstants {
    ...
    public static final double RUBBLE_SCORE_MULTIPLIER =3.54;
    public static final double RUBBLE_SCORE_LOCAL_MULTIPLIER =8.6;

    public static final int MIN_AFFORD_PATH_OPT =2000;
    public static final int NUM_BETTER_LOC_ITERATIONS =4;
    public static final int SOLDIER_PATHFINDING_LIMIT =2873;
    public static final int MINER_PATHFINDING_LIMIT =2241;
    public static final int DEFAULT_LIMIT =2798;
