...
public class PathFindingConstants {
    ...
    public static final double RUBBLE_SCORE_MULTIPLIER =4.54;
    public static final double RUBBLE_SCORE_LOCAL_MULTIPLIER =9.21;

    public static final int MIN_AFFORD_PATH_OPT =3147;
    public static final int NUM_BETTER_LOC_ITERATIONS =3;
    public static final int SOLDIER_PATHFINDING_LIMIT =3351;
    public static final int MINER_PATHFINDING_LIMIT =3173;
