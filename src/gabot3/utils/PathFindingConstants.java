...
public class PathFindingConstants {
    ...
    public static final double RUBBLE_SCORE_MULTIPLIER =5.46;
    public static final double RUBBLE_SCORE_LOCAL_MULTIPLIER =6.24;
    ...
    public static final int MINER_PATHFINDING_LIMIT =2200;
